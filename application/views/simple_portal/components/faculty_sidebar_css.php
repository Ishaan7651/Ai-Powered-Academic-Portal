<?php
/**
 * Shared CSS for Faculty Portal Sidebar and Layout
 * This file contains the standard styling used across all faculty-facing pages.
 */
?>
<style>
    :root {
        ...
        /* Gradients */
        --gradient-primary: linear-gradient(135deg, #1f5ea8, #114a7d);
        --gradient-success: linear-gradient(135deg, #78b83f, #5a942f);
