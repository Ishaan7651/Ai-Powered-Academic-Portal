...
<head>
    ...
    <title>Quiz Generator - AI Powered Academic Hub</title>
...
<div class="portal-container">
    <!-- Sidebar -->
    <!-- Sidebar -->
    <?php $this->load->view('simple_portal/components/faculty_sidebar', ['active_page' => 'quiz_generator']); ?>
    ...
    <div class="main-content">
        ...
        <header class="topbar">
            <div class="page-info">
                ...
                <div class="breadcrumb">Generate interactive quizzes from your documents</div>
            </div>
        ...
        <div class="content-grid">
            ...
            <div class="config-panel">
                ...
                <div class="config-body">
                    ...
                    <div class="alert alert-info">
                        ...
                        <small>Select one or more resources. The AI will analyze all selected documents and create comprehensive questions.</small>
                    </div>
                </div>
            </div>
            ...
            <div class="preview-panel">
                ...
                <div class="preview-body" id="quizPreview">
                    <div class="empty-state">
                        <i class="fas fa-question-circle"></i>
                        <h3>No Quiz Generated Yet</h3>
                        <p>Configure your quiz settings and click "Generate Quiz" to create questions.</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="modal" id="loadingModal">
    <div class="modal-content">
        ...
        <h3 style="margin-bottom: 10px;">Generating Quiz...</h3>
        <p style="color: var(--text-light); margin: 0;">AI is analyzing your document and creating questions. This may take a moment.</p>
    </div>
</div>
...
<div class="modal" id="publishModal">
    <div class="modal-content">
        <h3 style="margin-bottom: 20px; color: var(--success-green);">
            <i class="fas fa-share-alt me-2"></i>Publish Quiz
        </h3>
        <p style="margin-bottom: 20px; color: var(--text-light);">
            This will make the quiz available to students enrolled in the selected subject.
        </p>
...
document.getElementById('quizForm').addEventListener('submit', function(e) {
    ...
    // Send request
    fetch('<?php echo base_url('simple_portal/process_quiz_generation'); ?>', {
        method: 'POST',
    ...
    .then(data => {
        ...
        if (data.success) {
            ...
            alertDiv.innerHTML = '<i class="fas fa-check-circle me-2"></i>Quiz generated successfully!';
...
function displayQuiz(quizData) {
            ...
            quiz.questions.forEach((q, index) => {
                html += `
                    <div class="question-card">
                        ...
                        ${q.explanation ? `<div style="margin-top: 10px; font-size: 14px; color: var(--text-light); font-style: italic;">${q.explanation}</div>` : ''}
                    </div>
                `;
            });
        } else {
            html += '<p style="color: var(--text-light);">No questions generated</p>';
        }
    } catch (e) {
        html += '<p style="color: var(--error-red);">Error parsing quiz data</p>';
    }
    ...
    html += `
        <div class="action-buttons">
            ...
            <button class="btn btn-publish" onclick="showPublishModal()" ${!currentQuizId ? 'disabled' : ''}>
...
function showPublishModal() {
    if (!currentQuizId || !currentSubjectId) {
        alert('Please generate a quiz first and select a subject.');
        return;
    }
...
function confirmPublish() {
    ...
    fetch('<?php echo base_url('simple_portal/publish_quiz'); ?>', {
        method: 'POST',
        body: formData
    })
    .then(response => response.json())
    .then(data => {
        ...
        if (data.success) {
            ...
            const alertDiv = document.createElement('div');
            alertDiv.className = 'alert alert-success';
            alertDiv.innerHTML = '<i class="fas fa-check-circle me-2"></i>Quiz published successfully! Students can now access it.';
            alertDiv.style.position = 'fixed';
            alertDiv.style.top = '20px';
            alertDiv.style.right = '20px';
            alertDiv.style.zIndex = '1001';
            ...
            alert('Error: ' + (data.error || 'Failed to publish quiz'));
        }
    })
    .catch(error => {
        console.error('Error:', error);
