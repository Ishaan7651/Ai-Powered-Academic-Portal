...
<head>
    ...
    <title>Create Student - SLAi</title>
    ...
    <style>
        ...
        .form-control:focus {
            ...
            box-shadow: 0 0 0 4px rgba(120, 184, 63, 0.15);
        }
        ...
        .btn-primary {
            ...
            color: white;
            box-shadow: 0 4px 12px rgba(120, 184, 63, 0.2);
        }

        .btn-primary:hover {
            transform: translateY(-2px);
            box-shadow: 0 6px 16px rgba(120, 184, 63, 0.3);
        }
        ...
        .upload-area:hover {
            border-color: var(--success-green);
            background: rgba(120, 184, 63, 0.05);
        }

        .upload-area.dragover {
            border-color: var(--success-green);
            background: rgba(120, 184, 63, 0.1);
        ...
        <div class="content-area">
            ...
            <div class="dashboard-header">
                <div class="header-title">
                    ...
                    <p>Add students individually or upload multiple students via CSV/Excel</p>
                </div>
            </div>
            ...
            <div class="main-card">
                <div class="card-header">
                    <div class="card-title">
                        <i class="fas fa-graduation-cap" style="color: var(--success-green);"></i>
                ...
                <div class="card-body">
                    ...
                    <div class="tabs-container">
                        <div class="tabs">
                            <button class="tab active" onclick="switchTab('single')">
                                <i class="fas fa-user-plus"></i> Single Student
                            </button>
                    ...
                    <div id="single-tab" class="tab-content active">
                        <div class="form-container">
                            <form method="POST" action="<?php echo base_url('simple_portal/create_student'); ?>">
                                ...
                                <div class="form-grid" style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="email" class="form-control" 
                                               ...
                                               required>
                                        <div class="form-hint">Student's institutional email address</div>
                                    </div>
                                </div>
                                ...
                                <div class="form-grid" style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="student_id" class="form-control" 
                                               placeholder="e.g., STU001 (optional)">
                                        <div class="form-hint">Unique student identification number (optional)</div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-hint">Student's department/program</div>
                                </div>
                                ...
                                <div class="form-grid" style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                                    <div class="form-group">
                                        ...
                                        <div class="form-hint">Student's current semester</div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-hint">Year of enrollment (defaults to current year)</div>
                                    </div>
                                </div>
                        ...
                        <div class="form-container">
                            ...
                            <div class="template-box">
                                <div class="template-info">
                                    ...
                                    <p>Download the CSV template, fill in student details, and upload it below.</p>
                                </div>
                                <a href="<?php echo base_url('simple_portal/download_student_template'); ?>" class="btn btn-primary btn-download" style="text-decoration: none;">
                                    <i class="fas fa-file-csv"></i> Download CSV
                                </a>
                            </div>

                            <!-- Upload Form -->
                            <form method="POST" action="<?php echo base_url('simple_portal/bulk_upload_students'); ?>" enctype="multipart/form-data" id="bulkUploadForm">
                                ...
                                <div class="upload-area" id="uploadArea" onclick="document.getElementById('fileInput').click()">
                                    ...
                                    <input type="file" id="fileInput" name="student_file" class="file-input" accept=".csv,.xlsx,.xls" required style="display: none;">
                                </div>
                            ...
                            <div style="margin-top: 30px; padding: 25px; background: #f8fafc; border-radius: 12px; border: 1px solid var(--border-color);">
                                ...
                                <ul style="color: var(--text-light); line-height: 1.8; font-size: 14px; padding-left: 20px;">
                                    <li><strong>Required columns:</strong> username, email, password, current_semester, department_id</li>
                                    <li><strong>Optional columns:</strong> student_id, enrollment_year</li>
                                    <li><strong>Department IDs:</strong> 1=BTech AI and ML, 2=BSc Psychology, 3=BTech Sound Engineering, 4=BBA, 5=MBA</li>
                                    ...
                                    <li><strong>Current Semester:</strong> Number 1-8</li>
                                    <li><strong>Example:</strong> john.doe,john@college.edu,password123,1,STU001,2025</li>
                                </ul>
                            </div>
                        </div>
                    </div>
